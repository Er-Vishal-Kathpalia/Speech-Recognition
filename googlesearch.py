...
class Ui_googlewindow(object):
    def setupUi(self, googlewindow):
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("C:/Users/Vishal Kathpalia/AppData/Local/Programs/Python/Python39/srpyqt/img/download.png"))
    ...
    def retranslateUi(self, googlewindow):
        ...
        self.actionmain.setText(_translate("googlewindow", "Main Window"))
